...
#_______________________________________________________________________
	...
	def EmergencyBrakingTest(self):
		if(self.trainNum == 1 and self.eBrakeTest1 == True):
			signals.tnm_ebrake.emit(self.eBrakeTest1, self.trainNum)
			print("eBrake is " + str(self.eBrakeTest1))
		elif(self.trainNum == 2 and self.eBrakeTest2 == True):
			signals.tnm_ebrake.emit(self.eBrakeTest2, self.trainNum)
		elif(self.trainNum == 3 and self.eBrakeTest3 == True):
			signals.tnm_ebrake.emit(self.eBrakeTest3, self.trainNum)
		elif(self.trainNum == 4 and self.eBrakeTest4 == True):
			signals.tnm_ebrake.emit(self.eBrakeTest4, self.trainNum)
		elif(self.trainNum == 5 and self.eBrakeTest5 == True):
			signals.tnm_ebrake.emit(self.eBrakeTest5, self.trainNum)
		elif(self.trainNum == 6 and self.eBrakeTest6 == True):
			signals.tnm_ebrake.emit(self.eBrakeTest6, self.trainNum)
		elif(self.trainNum == 7 and self.eBrakeTest7 == True):
			signals.tnm_ebrake.emit(self.eBrakeTest7, self.trainNum)
		elif(self.trainNum == 8 and self.eBrakeTest8 == True):
			signals.tnm_ebrake.emit(self.eBrakeTest8, self.trainNum)
	...
	def brake_fail_act(self):
		if(self.trainNum == 1):
			...
			if(self.ui.lineEdit.text() == "Off" or self.ui.lineEdit.text() == "OFF" or self.ui.lineEdit.text() == "off"):	
				...
				signals.tnm_sendyard.emit(False ,self.trainNum)	
				...
				self.EmergencyBrakingTest()
				self.sendYard1 = True
				signals.tnm_sendyard.emit(True, self.trainNum)
			else:
				self.car1_status1 = True
...
#_______________________________________________________________________
	...
	def update_MoveStat(self):
		...
		if(self.TrainNum == 1):
			...
			signals.tnm_curr_speed.emit(self.curr_speed1,self.TrainNum)
			...
			signals.tnm_authority.emit(self.block_authority1,self.TrainNum)
			#Address Commanded Speed
			signals.tnm_comm_speed.emit(self.comm_speed1,self.TrainNum)
		...
		#___________________________________________________________________________
			...
			#Send the new calculated current speed to Train Controller
			signals.tnm_curr_speed.emit(self.curr_speed2,self.TrainNum)
			...
			#Address Authority Here
			signals.tnm_authority.emit(self.block_authority2,self.TrainNum)
			#Address Commanded Speed
			signals.tnm_comm_speed.emit(self.comm_speed2,self.TrainNum)
		...
		#___________________________________________________________________________
			...
			#Send the new calculated current speed to Train Controller
			signals.tnm_curr_speed.emit(self.curr_speed3,self.TrainNum)
			...
			#Address Authority Here
			signals.tnm_authority.emit(self.block_authority3,self.TrainNum)
			#Address Commanded Speed
			signals.tnm_comm_speed.emit(self.comm_speed3,self.TrainNum)
		...
		#___________________________________________________________________________
			...
			#Send the new calculated current speed to Train Controller
			signals.tnm_curr_speed.emit(self.curr_speed4,self.TrainNum)
			...
			#Address Authority Here
			signals.tnm_authority.emit(self.block_authority4,self.TrainNum)
			#Address Commanded Speed
			signals.tnm_comm_speed.emit(self.comm_speed4,self.TrainNum)
		...
		#___________________________________________________________________________
			...
			#Send the new calculated current speed to Train Controller
			signals.tnm_curr_speed.emit(self.curr_speed5,self.TrainNum)
			...
			#Address Authority Here
			signals.tnm_authority.emit(self.block_authority5,self.TrainNum)
			#Address Commanded Speed
			signals.tnm_comm_speed.emit(self.comm_speed5,self.TrainNum)
		...
		#___________________________________________________________________________
			...
			#Send the new calculated current speed to Train Controller
			signals.tnm_curr_speed.emit(self.curr_speed6,self.TrainNum)
			...
			#Address Authority Here
			signals.tnm_authority.emit(self.block_authority6,self.TrainNum)
			#Address Commanded Speed
			signals.tnm_comm_speed.emit(self.comm_speed6,self.TrainNum)
		...
		#___________________________________________________________________________
			...
			#Send the new calculated current speed to Train Controller
			signals.tnm_curr_speed.emit(self.curr_speed7,self.TrainNum)
			...
			#Address Authority Here
			signals.tnm_authority.emit(self.block_authority7,self.TrainNum)
			#Address Commanded Speed
			signals.tnm_comm_speed.emit(self.comm_speed7,self.TrainNum)
		...
		#___________________________________________________________________________
			...
			#Send the new calculated current speed to Train Controller
			signals.tnm_curr_speed.emit(self.curr_speed8,self.TrainNum)
			...
			#Address Authority Here
			signals.tnm_authority.emit(self.block_authority8,self.TrainNum)
			#Address Commanded Speed
			signals.tnm_comm_speed.emit(self.comm_speed8,self.TrainNum)
	...
	def update_RouteInfo(self):
		...
		if(self.TrainNum == 1):
			...
			if (self.BeaconIDStatus == False):
				...
				signals.tnm_beaconID.emit(self.beacon_bin1,self.TrainNum)
			...
			if (self.BeaconIDStatus == False):
				...
				self.ui.lineEdit_12.setText("Recieved")
				signals.tnm_beaconID.emit(self.beacon_bin2,self.TrainNum)
			...
			if (self.BeaconIDStatus == False):
				...
				self.ui.lineEdit_12.setText("Recieved")
				signals.tnm_beaconID.emit(self.beacon_bin3,self.TrainNum)
			...
			if (self.BeaconIDStatus == False):
				...
				self.ui.lineEdit_12.setText("Recieved")
				signals.tnm_beaconID.emit(self.beacon_bin4,self.TrainNum)
			...
			if (self.BeaconIDStatus == False):
				...
				self.ui.lineEdit_12.setText("Recieved")
				signals.tnm_beaconID.emit(self.beacon_bin5,self.TrainNum)
			...
			if (self.BeaconIDStatus == False):
				...
				self.ui.lineEdit_12.setText("Recieved")
				signals.tnm_beaconID.emit(self.beacon_bin6,self.TrainNum)
			...
			if (self.BeaconIDStatus == False):
				...
				self.ui.lineEdit_12.setText("Recieved")
				signals.tnm_beaconID.emit(self.beacon_bin7,self.TrainNum)
			...
			if (self.BeaconIDStatus == False):
				...
				self.ui.lineEdit_12.setText("Recieved")
				signals.tnm_beaconID.emit(self.beacon_bin8,self.TrainNum)
	...
	def EmergencyBraking(self):
		if(self.TrainNum == 1):
			if not self.eBrake1:
				...
				self.eBrake1 = True
				signals.tnm_ebrake.emit(self.eBrake1,self.TrainNum)
		...
		#______________________________________
			...
			if not self.eBrake2:
				...
				self.ui.pushButton.setStyleSheet("background-color: rgb(170, 0, 0); color: white;")
				self.eBrake2 = True
				signals.tnm_ebrake.emit(self.eBrake2,self.TrainNum)
		...
		#______________________________________
			...
			if not self.eBrake3:
				...
				self.ui.pushButton.setStyleSheet("background-color: rgb(170, 0, 0); color: white;")
				self.eBrake3 = True
				signals.tnm_ebrake.emit(self.eBrake3,self.TrainNum)
		...
		#______________________________________
			...
			if not self.eBrake4:
				...
				self.ui.pushButton.setStyleSheet("background-color: rgb(170, 0, 0); color: white;")
				self.eBrake4 = True
				signals.tnm_ebrake.emit(self.eBrake4,self.TrainNum)
		...
		#______________________________________
			...
			if not self.eBrake5:
				...
				self.ui.pushButton.setStyleSheet("background-color: rgb(170, 0, 0); color: white;")
				self.eBrake5 = True
				signals.tnm_ebrake.emit(self.eBrake5,self.TrainNum)
		...
		#______________________________________
			...
			if not self.eBrake6:
				...
				self.ui.pushButton.setStyleSheet("background-color: rgb(170, 0, 0); color: white;")
				self.eBrake6 = True
				signals.tnm_ebrake.emit(self.eBrake6,self.TrainNum)
		...
		#______________________________________
			...
			if not self.eBrake7:
				...
				self.ui.pushButton.setStyleSheet("background-color: rgb(170, 0, 0); color: white;")
				self.eBrake7 = True
				signals.tnm_ebrake.emit(self.eBrake7,self.TrainNum)
		...
		#______________________________________
			...
			if not self.eBrake8:
				...
				self.ui.pushButton.setStyleSheet("background-color: rgb(170, 0, 0); color: white;")
				self.eBrake8 = True
				signals.tnm_ebrake.emit(self.eBrake8,self.TrainNum)
	...
	def SetBeaconID(self,tkm_beacon):
		...
		if(self.TrainNum == 1):
			...
			if(self.beacon_bin1[2] == 0):
				...
				self.tnm_TrainDir.emit(self.TrainDirection1,self.TrainNum)
			...
			signals.tnm_curr_station.emit(self.CurrStation1,self.TrainNum)
			#______________________________________________________________________
		elif(self.TrainNum == 2):
			#Call function to append beacon
			...
			if(self.beacon_bin2[2] == 0):
				...
				self.tnm_TrainDir.emit(self.TrainDirection2,self.TrainNum)
			...
			signals.tnm_curr_station.emit(self.CurrStation2,self.TrainNum)
			#______________________________________________________________________
		elif(self.TrainNum == 3):
			#Call function to append beacon
			...
			if(self.beacon_bin3[2] == 0):
				...
				self.tnm_TrainDir.emit(self.TrainDirection3,self.TrainNum)
			...
			signals.tnm_curr_station.emit(self.CurrStation3,self.TrainNum)
			#______________________________________________________________________
		elif(self.TrainNum == 4):
			#Call function to append beacon
			...
			if(self.beacon_bin4[2] == 0):
				...
				self.tnm_TrainDir.emit(self.TrainDirection4,self.TrainNum)
			...
			signals.tnm_curr_station.emit(self.CurrStation4,self.TrainNum)
			#______________________________________________________________________
		elif(self.TrainNum == 5):
			#Call function to append beacon
			...
			if(self.beacon_bin5[2] == 0):
				...
				self.tnm_TrainDir.emit(self.TrainDirection5,self.TrainNum)
			...
			signals.tnm_curr_station.emit(self.CurrStation5,self.TrainNum)
			#______________________________________________________________________
		elif(self.TrainNum == 6):
			#Call function to append beacon
			...
			if(self.beacon_bin6[2] == 0):
				...
				self.tnm_TrainDir.emit(self.TrainDirection6,self.TrainNum)
			...
			signals.tnm_curr_station.emit(self.CurrStation6,self.TrainNum)
			#______________________________________________________________________
		elif(self.TrainNum == 7):
			#Call function to append beacon
			...
			if(self.beacon_bin7[2] == 0):
				...
				self.tnm_TrainDir.emit(self.TrainDirection7,self.TrainNum)
			...
			signals.tnm_curr_station.emit(self.CurrStation7,self.TrainNum)
			#______________________________________________________________________
		elif(self.TrainNum == 8):
			#Call function to append beacon
			...
			if(self.beacon_bin8[2] == 0):
				...
				self.tnm_TrainDir.emit(self.TrainDirection8,self.TrainNum)
			...
			signals.tnm_curr_station.emit(self.CurrStation8,self.TrainNum)
			#______________________________________________________________________
