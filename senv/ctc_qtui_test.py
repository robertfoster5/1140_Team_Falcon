...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboStation_2.setItemText(0, _translate("MainWindow", "Edgebrook"))
        self.comboStation_2.setItemText(1, _translate("MainWindow", "Pioneer"))
        self.comboStation_2.setItemText(2, _translate("MainWindow", "Falcon"))
        self.comboStation_2.setItemText(3, _translate("MainWindow", "Whited"))
        self.comboStation_2.setItemText(4, _translate("MainWindow", "South Bank"))
        self.comboStation_2.setItemText(5, _translate("MainWindow", "Central"))
        self.comboStation_2.setItemText(6, _translate("MainWindow", "Inglewood"))
        self.comboStation_2.setItemText(7, _translate("MainWindow", "Overbrook"))
        self.comboStation_2.setItemText(8, _translate("MainWindow", "Yard"))
        self.comboStation_2.setItemText(9, _translate("MainWindow", "Glenbury"))
        self.comboStation_2.setItemText(10, _translate("MainWindow", "Dormont"))
        self.comboStation_2.setItemText(11, _translate("MainWindow", "Mt Lebanon"))
        self.comboStation_2.setItemText(12, _translate("MainWindow", "Poplar"))
        self.comboStation_2.setItemText(13, _translate("MainWindow", "Castle Shannon"))
