...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_21 = QtWidgets.QLabel(self.tab_maintenance)
        self.label_21.setGeometry(QtCore.QRect(30, 120, 231, 21))
        self.label_21.setObjectName("label_21")
        self.label_22 = QtWidgets.QLabel(self.tab_maintenance)
        self.label_22.setGeometry(QtCore.QRect(390, 120, 231, 21))
        self.label_22.setObjectName("label_22")
        self.label_23 = QtWidgets.QLabel(self.tab_maintenance)
        self.label_23.setGeometry(QtCore.QRect(30, 150, 231, 21))
        self.label_23.setObjectName("label_23")
        self.label_24 = QtWidgets.QLabel(self.tab_maintenance)
        self.label_24.setGeometry(QtCore.QRect(390, 150, 231, 21))
        self.label_24.setObjectName("label_24")
        self.labelCurrSwitchPos = QtWidgets.QLabel(self.tab_maintenance)
        self.labelCurrSwitchPos.setGeometry(QtCore.QRect(270, 120, 161, 21))
        self.labelCurrSwitchPos.setObjectName("labelCurrSwitchPos")
        self.labelNewSwitchPos = QtWidgets.QLabel(self.tab_maintenance)
        self.labelNewSwitchPos.setGeometry(QtCore.QRect(270, 150, 161, 21))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.labelNewSwitchPos.setFont(font)
        self.labelNewSwitchPos.setObjectName("labelNewSwitchPos")
        self.labelCurrBlockPos = QtWidgets.QLabel(self.tab_maintenance)
        self.labelCurrBlockPos.setGeometry(QtCore.QRect(630, 120, 161, 21))
        self.labelCurrBlockPos.setObjectName("labelCurrBlockPos")
        self.labelNewBlockPos = QtWidgets.QLabel(self.tab_maintenance)
        self.labelNewBlockPos.setGeometry(QtCore.QRect(630, 150, 161, 21))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.labelNewBlockPos.setFont(font)
        self.labelNewBlockPos.setObjectName("labelNewBlockPos")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboSwitch.setItemText(0, _translate("MainWindow", "Switch (Block 5)"))
        ...
        self.label_21.setText(_translate("MainWindow", "Current Switch Position:"))
        self.label_22.setText(_translate("MainWindow", "Current Block State:"))
        self.label_23.setText(_translate("MainWindow", "New Switch Position:"))
        self.label_24.setText(_translate("MainWindow", "New Block State:"))
        self.labelCurrSwitchPos.setText(_translate("MainWindow", "..."))
        self.labelNewSwitchPos.setText(_translate("MainWindow", "..."))
        self.labelCurrBlockPos.setText(_translate("MainWindow", "..."))
        self.labelNewBlockPos.setText(_translate("MainWindow", "..."))
